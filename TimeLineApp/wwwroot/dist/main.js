...
(function main() {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_6__('#canvas').on('contextmenu', (e) => {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_6__('#newTimeline').click((ev) => {
        OpenNewTLDialog();
    });
    jquery__WEBPACK_IMPORTED_MODULE_6__('#load').click((ev) => {
        LoadTimeLine();
    });
    jquery__WEBPACK_IMPORTED_MODULE_6__('#save').click((ev) => {
        alert('save');
    });
    jquery__WEBPACK_IMPORTED_MODULE_6__('#options').click((ev) => {
        jquery__WEBPACK_IMPORTED_MODULE_6__('#typePeriod').val(_TLEvent__WEBPACK_IMPORTED_MODULE_5__["EnumPeriod"].year);
        jquery__WEBPACK_IMPORTED_MODULE_6__('#tmOptionsModal').modal();
    });
    jquery__WEBPACK_IMPORTED_MODULE_6__('#btnNewName').click((ev) => {
        jquery__WEBPACK_IMPORTED_MODULE_6__('#tmNameModal').modal('hide');
        NewTimeLine(jquery__WEBPACK_IMPORTED_MODULE_6__('#tmName').val());
    });
    jquery__WEBPACK_IMPORTED_MODULE_6__('.closenamemodal').click((ev) => {
        jquery__WEBPACK_IMPORTED_MODULE_6__('#tmNameModal').modal('hide');
    });
    jquery__WEBPACK_IMPORTED_MODULE_6__('.closeoptionmodal').click((ev) => {
        jquery__WEBPACK_IMPORTED_MODULE_6__('#tmOptionsModal').modal('hide');
    });
    jquery__WEBPACK_IMPORTED_MODULE_6__('.closeregistermodal').click((ev) => {
        jquery__WEBPACK_IMPORTED_MODULE_6__('#tmRegisterModal').modal('hide');
    });
    jquery__WEBPACK_IMPORTED_MODULE_6__('.closeloginmodal').click((ev) => {
        jquery__WEBPACK_IMPORTED_MODULE_6__('#tmLoginModal').modal('hide');
    });
    jquery__WEBPACK_IMPORTED_MODULE_6__('.closeloadmodal').click((ev) => {
        jquery__WEBPACK_IMPORTED_MODULE_6__('#tmLoadModal').modal('hide');
    });
    jquery__WEBPACK_IMPORTED_MODULE_6__('#tmName').keyup((ev) => {
        if (jquery__WEBPACK_IMPORTED_MODULE_6__('#tmName').val().trim() !== '') {
            jquery__WEBPACK_IMPORTED_MODULE_6__('#btnNewName').prop('disabled', false);
            if (ev.keyCode === 13) {
                jquery__WEBPACK_IMPORTED_MODULE_6__('#tmNameModal').modal('hide');
                NewTimeLine(jquery__WEBPACK_IMPORTED_MODULE_6__('#tmName').val());
            }
            ...
            jquery__WEBPACK_IMPORTED_MODULE_6__('#btnNewName').prop('disabled', true);
        }
    });
    jquery__WEBPACK_IMPORTED_MODULE_6__('#tmNameModal').on('shown.bs.modal', function () {
        jquery__WEBPACK_IMPORTED_MODULE_6__('#tmName').trigger('focus');
    });
    jquery__WEBPACK_IMPORTED_MODULE_6__('#action01').click((ev) => {
        alert('action01');
    });
    jquery__WEBPACK_IMPORTED_MODULE_6__('#regPassword1').focus(ev => {
        jquery__WEBPACK_IMPORTED_MODULE_6__('#passw_not_matches').css('display', 'none');
    });
    jquery__WEBPACK_IMPORTED_MODULE_6__('#regPassword2').focus(ev => {
        jquery__WEBPACK_IMPORTED_MODULE_6__('#passw_not_matches').css('display', 'none');
    });
    jquery__WEBPACK_IMPORTED_MODULE_6__('#logPassword').focus(ev => {
        jquery__WEBPACK_IMPORTED_MODULE_6__('#log_server_error').css('display', 'none');
    });
    // Открытие окна регистрации пользователя btnReg
    jquery__WEBPACK_IMPORTED_MODULE_6__('#btnReg').click(_RegisterHandlers__WEBPACK_IMPORTED_MODULE_4__["RegisterHandlers"].OpenRegisterWindow);
    // Регистрация пользователя btnRegisterUser
    jquery__WEBPACK_IMPORTED_MODULE_6__('#btnRegisterUser').click(_RegisterHandlers__WEBPACK_IMPORTED_MODULE_4__["RegisterHandlers"].RegisterUser);
    // Открытие окна входа пользователя btnLogin
    jquery__WEBPACK_IMPORTED_MODULE_6__('#btnLogin').click(_LogonHandlers__WEBPACK_IMPORTED_MODULE_3__["LogonHandlers"].OpenLogonWindow);
    // Вход пользователя btnLoginUser
    jquery__WEBPACK_IMPORTED_MODULE_6__('#btnLoginUser').click(_LogonHandlers__WEBPACK_IMPORTED_MODULE_3__["LogonHandlers"].LoginLogout);
    // Загрузка TL btnLoadTL
    jquery__WEBPACK_IMPORTED_MODULE_6__('#btnLoadTL').click(LoadTimeLine);
})();
function LoadTimeLine() {
    jquery__WEBPACK_IMPORTED_MODULE_6__["ajax"]('api/storage/load', { data: {
            fname: jquery__WEBPACK_IMPORTED_MODULE_6__('#files_list').val()
        }
    })
        .done(data => {
...
function OpenLoadTLDialog() {
    _timeline__WEBPACK_IMPORTED_MODULE_0__["TimeLine"].getList()
        .then(value => {
        let files_list = jquery__WEBPACK_IMPORTED_MODULE_6__('#files_list');
        files_list.find('option').remove();
        for (let i = 0; i < value.length; i++) {
            files_list.append(jquery__WEBPACK_IMPORTED_MODULE_6__('<option></option>', { value: value[i], text: value[i] }));
        }
        jquery__WEBPACK_IMPORTED_MODULE_6__('#tmLoadModal').modal();
    })
        .catch(responseText => {
...
function OpenNewTLDialog() {
    jquery__WEBPACK_IMPORTED_MODULE_6__('#tmName').val('');
    jquery__WEBPACK_IMPORTED_MODULE_6__('#btnNewName').prop('disabled', true);
    jquery__WEBPACK_IMPORTED_MODULE_6__('#tmNameModal').modal();
}
